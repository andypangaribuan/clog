...
func init() {
	add(func(dbi ice.DbInstance) {
		ServicePieceV1 = new(dbi, "service_piece_v1", `
					...
					url, req_version, req_header, req_param, req_query,
					req_form, req_body, client_ip, started_at`,
			func(e *entity.ServicePieceV1) []any {
				return []any{
					e.CreatedAt, e.Uid,
					e.SvcName, e.SvcVersion, e.SvcParentName, e.SvcParentVersion, e.Endpoint,
					e.Url, e.ReqVersion, e.ReqHeader, e.ReqParam, e.ReqQuery,
					e.ReqForm, e.ReqBody, e.ClientIp, e.StartedAt,
				}
			})
	})
}
