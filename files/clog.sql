...
CREATE INDEX `service_log_idx_userId` ON `clog`.`service_log` (`user_id` ASC) VISIBLE;

CREATE INDEX `service_log_idx_partnerId` ON `clog`.`service_log` (`partner_id` ASC) VISIBLE;

CREATE INDEX `service_log_idx_xid` ON `clog`.`service_log` (`xid` ASC) VISIBLE;

CREATE INDEX `service_log_idx_userId_partnerId` ON `clog`.`service_log` (`user_id` ASC, `partner_id` ASC) VISIBLE;
...
CREATE INDEX `info_log_idx_userId` ON `clog`.`info_log` (`user_id` ASC) VISIBLE;

CREATE INDEX `info_log_idx_partnerId` ON `clog`.`info_log` (`partner_id` ASC) VISIBLE;

CREATE INDEX `info_log_idx_xid` ON `clog`.`info_log` (`xid` ASC) VISIBLE;

CREATE INDEX `info_log_idx_userId_partnerId` ON `clog`.`info_log` (`user_id` ASC, `partner_id` ASC) VISIBLE;
...
CREATE INDEX `dbq_log_idx_userId` ON `clog`.`dbq_log` (`user_id` ASC) VISIBLE;

CREATE INDEX `dbq_log_idx_partnerId` ON `clog`.`dbq_log` (`partner_id` ASC) VISIBLE;

CREATE INDEX `dbq_log_idx_xid` ON `clog`.`dbq_log` (`xid` ASC) VISIBLE;

CREATE INDEX `dbq_log_idx_userId_partnerId` ON `clog`.`dbq_log` (`user_id` ASC, `partner_id` ASC) VISIBLE;
