...
pub struct LogBatchRequest {
    ...
    pub entries: ::prost::alloc::vec::Vec<LogEntryRequest>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct LogEntryRequest {
    ...
    #[prost(string, tag = "8")]
    pub partner_uid: ::prost::alloc::string::String,
    #[prost(string, tag = "9")]
...
pub mod log_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(inner: T, interceptor: F) -> LogServiceClient<InterceptedService<T, F>>
        where
        ...
        pub async fn push_batch(
            &mut self,
            request: impl tonic::IntoRequest<super::LogBatchRequest>,
            ...
            let path = http::uri::PathAndQuery::from_static("/grc_clog.LogService/PushBatch");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("grc_clog.LogService", "PushBatch"));
...
pub mod log_service_server {
    ...
    #[async_trait]
    pub trait LogService: std::marker::Send + std::marker::Sync + 'static {
        /// batch processing of log entries
        async fn push_batch(
            &self,
            request: tonic::Request<super::LogBatchRequest>,
        ) -> std::result::Result<tonic::Response<super::LogResponse>, tonic::Status>;
    }
    /// service for push the log from app services using rmod.
    #[derive(Debug)]
    pub struct LogServiceServer<T> {
        inner: Arc<T>,
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/grc_clog.LogService/PushBatch" => {
                    #[allow(non_camel_case_types)]
                    struct PushBatchSvc<T: LogService>(pub Arc<T>);
                    impl<T: LogService> tonic::server::UnaryService<super::LogBatchRequest> for PushBatchSvc<T> {
                        type Response = super::LogResponse;
                        type Future = BoxFuture<tonic::Response<Self::Response>, tonic::Status>;
                        fn call(&mut self, request: tonic::Request<super::LogBatchRequest>) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move { <T as LogService>::push_batch(&inner, request).await };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T> Clone for LogServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "grc_clog.LogService";
    impl<T> tonic::server::NamedService for LogServiceServer<T> {
